        ...
        <form action="index.php" method="post" name="adminForm" id="adminForm">
            <div id="js-tk-filter">
                ...
                <div class="tk-search-button">
                    ...
                    <button onclick="document.getElementById('filter_fieldtitle').value = ''; this.form.submit();"><?php echo JText::_('Reset'); ?></button>
                </div>
            </div>
            <?php
                    ...
                    <table id="js-table" class="js-ticket-box-shadow">
                        ...
                        <tbody>
                            ...
                            foreach ($this->items AS $row) {
                                ...
                                $deletelink = 'index.php?option='.$this->option.'&c=userfields&task=removeuserfields&cid[]='.$row->id.'&' . JSession::getFormToken() . '=1'; ?>
                                <tr>
